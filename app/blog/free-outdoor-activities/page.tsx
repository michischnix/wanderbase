...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-ivan-samkov-9629911%20%281%29-eWbgB675OMJCeDjoibLceavtiTewh5.jpg",
        width: 1200,
        height: 630,
        alt: "Close-up of hiking boots on mossy forest ground, representing accessible free outdoor activities",
      },
    ],
  },
}
...
export default function FreeOutdoorActivitiesPage() {
  const post = {
    ...
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-ivan-samkov-9629911%20%281%29-eWbgB675OMJCeDjoibLceavtiTewh5.jpg",
  }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            <p className="leading-relaxed text-foreground first-letter:text-6xl first-letter:font-bold first-letter:text-primary first-letter:float-left first-letter:mr-3 first-letter:mt-1 font-medium text-xl">
              ...
              requires expensive equipment, some of the most rewarding outdoor experiences cost absolutely
          ...
          >
            ...
            <div className="callout callout-green my-8 p-6 border-l-4 bg-green-50 border-green-400 text-green-900">
              ...
              entertainment and often lead to lifelong hobbies. Compare that to a €50 theme park ticket for a few hours
              of manufactured fun.
            </div>
            ...
            <p>
              ...
              life in tide pools. Each item tells a story about ocean currents, weather patterns, and marine ecosystems.
            </p>
            ...
            <p>
              ...
              shoes. It develops problem-solving skills, builds confidence, and provides access to viewpoints that
              regular trails can't reach.
            </p>
            ...
            <p>
              ...
              but the mental health advantages—cold water therapy, connection with nature, seasonal awareness—make this
              a powerful wellness practice.
            </p>
            ...
            <p>
              The best part of free outdoor activities is sharing discoveries with others. Create a local group focused
              on budget adventures, or join existing communities online. Knowledge sharing multiplies everyone's
              opportunities.
            </p>
            ...
            <div className="callout callout-green my-8 p-6 border-l-4 bg-green-50 border-green-400 text-green-900">
              <strong>💰 Community Benefit:</strong> Group activities often reduce individual costs further. Carpooling
              to distant locations, sharing equipment, and bulk buying supplies make adventures even more affordable.
            </div>

            <h2 id="monthly-challenge">Your Monthly Adventure Challenge</h2>

            <p>
              Commit to trying one new free outdoor activity each month. This approach prevents overwhelm while building
              a diverse skill set and expanding your adventure repertoire throughout the year.
            </p>
