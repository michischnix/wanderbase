      ...
      <div className="max-w-[750px] mx-auto px-6 py-16">
        ...
        <div className="space-y-8">
          <p className="text-lg leading-relaxed">
            ...
            Alpine travel, including hidden expenses that can dramatically shift the equation.
          </p>
          ...
          <p>
            ...
            raw number only begins to tell the story of public transport advantages.
          </p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6" id="success-stories">
          ...
          <p>
            Local hiking clubs leverage regional day passes for group adventures, typically reducing transport costs by
            60% compared to individual car travel. The predictable scheduling of public transport also facilitates group
            coordination and ensures everyone arrives at trailheads simultaneously.
          </p>
