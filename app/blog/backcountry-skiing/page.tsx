...
const tableOfContentsItems = [
  { id: "what-is-backcountry", title: "What is Backcountry Skiing?" },
  { id: "essential-skills", title: "Essential Skills and Prerequisites" },
  { id: "safety-education", title: "Avalanche Safety Education" },
  { id: "essential-gear", title: "Essential Backcountry Gear" },
  { id: "planning-first-tour", title: "Planning Your First Tour" },
  { id: "building-experience", title: "Building Experience Safely" },
]
          ...
          <div className="lg:col-span-3">
            <div className="mb-12">
              <p className="leading-relaxed text-foreground first-letter:text-6xl first-letter:font-bold first-letter:text-primary first-letter:float-left first-letter:mr-3 first-letter:mt-1 font-medium text-xl">
                Backcountry skiing represents the ultimate expression of freedom on snow—earning your turns through
                human power, exploring untouched terrain, and experiencing the mountains in their purest form.
              </p>
            </div>
            ...
            >
              ...
              <p>
                ...
                unpatrolled terrain outside of ski resort boundaries. Unlike resort skiing, you must earn every descent
                by climbing uphill using specialized equipment, and you're responsible for your own safety and rescue.
              </p>

              <div className="callout callout-red my-8 p-6 border-l-4 bg-red-50 border-red-400 text-red-900">
                <strong>⚠️ Critical Safety Warning:</strong> Backcountry skiing involves serious risks including
                avalanches, cliff bands, tree wells, and weather exposure. Proper education and training are not
                optional—they are essential for survival. Never venture into the backcountry without proper avalanche
                education.
              </div>

              <p>
                Key differences from resort skiing include no groomed runs or marked boundaries, no ski patrol or
                immediate rescue services, avalanche risk assessment requirements, physical fitness demands for uphill
                travel, and the need for self-rescue skills and equipment.
              </p>
              ...
              <div className="callout callout-blue my-8 p-6 border-l-4 bg-blue-50 border-blue-400 text-blue-900">
                ...
                backcountry. The extra weight significantly affects your balance and technique, especially when
                fatigued.
              </div>

              <p>
                Prerequisites include advanced intermediate to expert resort skiing ability, comfort in all snow
                conditions, ability to ski steep terrain, strong parallel turns and edge control, and experience skiing
                in variable visibility. Physical fitness requirements include cardiovascular endurance, leg strength,
              ...
              <blockquote className="my-12 pl-8 border-l-4 border-primary italic text-xl font-medium">
                The mountains don't care about your experience level, your gear, or your plans. They only respond to
                your decisions and your respect for their power.
              </blockquote>
              ...
              <div className="callout callout-yellow my-8 p-6 border-l-4 bg-yellow-50 border-yellow-400 text-yellow-900">
                ...
                American Avalanche Association or Canadian Avalanche Association. Online courses can supplement but
                never replace hands-on field training.
              </div>

              <p>
                Required education levels include Level 1 (Avalanche Rescue) for basic companion rescue, Level 2
                (Avalanche Hazard Evaluation) for trip planning, Level 3 (Advanced Avalanche) for professional-level
                risk management, and ongoing education through regular refresher courses.
              </p>
              ...
              <p>
                The avalanche safety "Holy Trinity" includes an avalanche transceiver (digital beacon), probe
                (collapsible pole), and shovel (metal blade). Touring equipment includes lighter touring skis, bindings
                that allow heel lift, touring boots with walk mode, climbing skins for uphill traction, and ski crampons
                for icy conditions.
              </p>

              <div className="callout callout-green my-8 p-6 border-l-4 bg-green-50 border-green-400 text-green-900">
                <strong>💰 Investment Perspective:</strong> Quality backcountry gear is expensive but essential.
                Consider it life insurance rather than sporting equipment. Buy once, cry once—cheap safety gear can fail
              ...
              <p>
                Your first backcountry ski tour should be conservative, well-planned, and ideally guided by an
                experienced mentor or professional guide. The goal is to gain experience in a controlled environment
                while building confidence and skills.
              </p>
              ...
              <p>
                Backcountry skiing expertise develops over years of experience, continuous learning, and gradual
                progression to more challenging terrain. There are no shortcuts to mountain wisdom—it must be earned
                through time, practice, and sometimes difficult lessons.
              </p>
