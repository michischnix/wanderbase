...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/seasonal-budget-adventures.png",
        width: 1200,
        height: 630,
        alt: "Four seasons outdoor activities montage showing year-round budget adventures",
      },
    ],
  },
}
...
export default function SeasonalBudgetAdventuresPage() {
  ...
  const tableOfContents = [
    { id: "seasonal-mindset", title: "The Year-Round Adventure Mindset" },
    { id: "spring-adventures", title: "Spring: Renewal and Discovery" },
    { id: "summer-activities", title: "Summer: Water and Extended Daylight" },
    { id: "fall-experiences", title: "Fall: Colors and Comfortable Weather" },
    { id: "winter-opportunities", title: "Winter: Solitude and Snow Sports" },
    { id: "seasonal-gear", title: "Smart Seasonal Gear Strategies" },
    { id: "year-round-planning", title: "Planning Your Adventure Calendar" },
  ]
          ...
          <div className="lg:col-span-3">
            <div className="mb-12">
              <p className="leading-relaxed text-foreground first-letter:text-6xl first-letter:font-bold first-letter:text-primary first-letter:float-left first-letter:mr-3 first-letter:mt-1 font-medium text-xl">
                Most outdoor enthusiasts hibernate during certain seasons, missing incredible adventures that only
                happen during specific times of year. Each season offers unique opportunities for budget-conscious
                adventurers willing to adapt their activities to nature's rhythm.
              </p>
            </div>
            ...
            >
              ...
              <p>
                Seasonal outdoor activities cost significantly less than their peak-season counterparts. Spring
                wildflower hikes happen when parks offer reduced rates, winter activities avoid summer crowds and high
                prices, and fall adventures coincide with harvest season abundance.
              </p>

              <p>
                The key is embracing each season's unique character rather than fighting against it. Instead of
                expensive tropical vacations to escape winter, discover the beauty of snow sports. Rather than
                air-conditioned indoor activities during summer heat, find shaded forest trails and cool swimming holes.
              </p>
              ...
              <p>
                ...
                Research local wildflower calendars—many regions have specific weeks when different species peak,
                creating natural flower shows that change weekly.
              </p>

              <p>
                <strong>Best Locations:</strong> Desert regions for early spring blooms, mountain meadows for late
                spring displays, and woodland areas for forest floor flowers. Each ecosystem has its own wildflower
                timeline.
              </p>
              ...
              <p>
                <strong>Equipment Needed:</strong> Basic binoculars (€30-50) and a field guide or bird identification
                app. Many parks loan binoculars for free during migration season.
              </p>
              ...
              <div className="callout callout-blue my-8 p-6 border-l-4 bg-blue-50 border-blue-400 text-blue-900">
                ...
                calendars predict when wildflowers bloom, birds migrate, and waterfalls peak based on historical data
              ...
              <div className="callout callout-yellow my-8 p-6 border-l-4 bg-yellow-50 border-yellow-400 text-yellow-900">
                <strong>🌡️ Heat Strategy:</strong> Plan summer activities for early morning or evening hours. Dawn and
                dusk provide the best wildlife viewing, comfortable temperatures, and dramatic lighting for photography.
              </div>
              ...
              <p>
                <strong>Photography Tips:</strong> Overcast days provide even lighting for forest photography, while
                sunny days create dramatic contrasts. Early morning mist adds mystical quality to fall forest scenes.
              </p>
              ...
              <p>
                ...
                edible species. Always forage with experienced guides or take identification classes before consuming
                any wild mushrooms.
              </p>
              ...
              <p>
                ...
                strategies, fall weather variability, and winter storm preparations ensure adventures continue
              ...
              <blockquote className="my-12 pl-8 border-l-4 border-primary italic text-xl font-medium">
                ...
                seasons you dislike, you discover unique beauty and opportunities that exist only during specific times
                of year, creating a richer, more connected outdoor life.
              </blockquote>
            </div>
          </div>
        </div>
